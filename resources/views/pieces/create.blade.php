     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="nompiece" class="form-control" placeholder="nom..">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Reference') :</strong>
                <input class="form-control " name="referencep" placeholder="Refrence ..."></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong>@lang('Fournisseur'):</strong>
                <input class="form-control"  name="fournisseur" placeholder="fournisseur ..."></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Prix') :</strong>
                <input class="form-control"  name="prix" placeholder="prix..."></input>
            </div>
        </div>
