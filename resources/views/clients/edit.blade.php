...
<div class="row">
    <div class="col-lg-12 mt-10" >
        ...
        <div class="pull-right"style="margin-left:800px">
            <a class="btn btn-primary" href="{{ route('clients.index') }}">@lang('Retourner')</a>
        </div>
    </div>
</div>
     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="nom" class="form-control" placeholder="nom.." value="{{ $clt->nom }}">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Prenom') :</strong>
                <input class="form-control " name="prenom" placeholder="prenom ..." value="{{ $clt->prenom }}"></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong>@lang('Telephone') :</strong>
                <input class="form-control"  name="telephone" placeholder="telephone ..."  value="{{ $clt->telephone}}"></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Adresse') :</strong>
                <input class="form-control"  name="adresse" placeholder="adresse..." value="{{ $clt->adresse }}"></input>
            </div>
        </div>
