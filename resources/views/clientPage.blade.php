...
<div class="wrapper">
 ...
 @include('layouts.header')
  ...
  <aside class="main-sidebar sidebar-secondary ">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('https://i.pinimg.com/564x/c1/4d/42/c14d4224df992ee8f06ef82afff0d9c0.jpg')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info" style="color:rgb(8, 8, 8)">
        {{ Auth::user()->name }}
