        ...
        @foreach ($reparations as $rp)
            <tr id="row{{$rp->id}}">
               ...
               <td> {{$rp->nom_mecaniciens}}</td>
                ...
                <td>
                    <a class="btnEdit btn  bg-primary-emphasis hover:bg-primary-emphasis text-white font-bold  px-2 border-b-4 border-primary-emphasis hover:border-primary-emphasis rounded" href="{{route('reparations.edit',$rp->id)}}">@lang('Modifier')</a>
                </td>
            </tr>
        @endforeach
    </table>
