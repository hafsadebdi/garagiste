     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                ...
                <input class="form-control " name="modele" placeholder="modele ..."></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong>typeFuel :</strong>
                <input class="form-control"  name="typeFuel" placeholder="typeFuel ..."></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >Registration :</strong>
                <input class="form-control"  name="registration" placeholder="registration..."></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
